...
#ifndef ATTACHE_SWIFT_H
#define ATTACHE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Attache",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// from notification actions go through the bridge’s REST <code>/verdict</code> endpoint
...
SWIFT_CLASS("_TtC7Attache19NotificationManager")
